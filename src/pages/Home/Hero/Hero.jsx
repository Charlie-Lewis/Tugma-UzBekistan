      ...
      <header className={s.header}>
        <div className={s.container}>
          <div className={s.block_1}>
            <h2 className={s.subtitle}>Добро Пожаловать к нам!</h2>

            <h1 className={s.title}>
              Хай, Мы
              <br />
              <span className={s.highlight}>Tugma Uz</span>
              <br />
              Магазин Пуговиц
            </h1>

            <p className={s.text}>
Мы разрабатываем пуговицы под ваш собственный бренд,разумееться с вашим же цветом.
Так что мы ждем ваши предложеения
            </p>
          </div>

          <div className={s.block_2}>
            <BtnPrimary text={"Закажи скорей!"} padding={"13px 39px"} />

            <a className={s.btn} href="" download>
             Можете скачать наше приложение
              <svg
                className={s.svg}
                width="21"
                height="21"
        ...
        <img className={s.img_user} src="/public/Untitled_logo_1_free-file.jpg" alt="logo" />
      </header>
    </>
  );
};
